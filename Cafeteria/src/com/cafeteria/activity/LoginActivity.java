...
//									Welcome.class);
//							startActivity(intent);
							UserSession.getInstance(LoginActivity.this).setEmloyeeName(user.get(Constant.EMPLOYEE_NAME).toString());
							UserSession.getInstance(LoginActivity.this).setUserId(user.get(Constant.USER_ID).toString());
							UserSession.getInstance(LoginActivity.this).setAdmin(user.getBoolean(Constant.IS_ADMIN));
